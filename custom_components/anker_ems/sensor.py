...
SENSORS: tuple[AnkerEmsSensorDescription, ...] = (
    ...
    AnkerEmsSensorDescription(
        ...
        name="Dummy OS EMS Automatisch plan uitvoeringsreserve",
        native_unit_of_measurement=PERCENTAGE,
    ...
    AnkerEmsSensorDescription(
        ...
        name="Dummy OS EMS Automatisch plan minimale uitvoeringsmarge",
        native_unit_of_measurement=PERCENTAGE,
    ...
    AnkerEmsSensorDescription(
        ...
        name="Dummy OS EMS Automatisch plan bufferonderschrijding",
        native_unit_of_measurement="h",
