...
def _evaluation_attrs(data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "absolute_bias_kwh_per_day": evaluation.get("internal_home_forecast_evaluation_absolute_bias_kwh_per_day"),
        "predicted_total_kwh": evaluation.get("internal_home_forecast_evaluation_predicted_total_kwh"),
        "actual_total_kwh": evaluation.get("internal_home_forecast_evaluation_actual_total_kwh"),
        ...
        "retention_days": evaluation.get("internal_home_forecast_evaluation_retention_days"),
        "min_actual_coverage_percent": evaluation.get("internal_home_forecast_evaluation_min_actual_coverage_percent"),
...
def _transition_attrs(data: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "active_source_unchanged": data.get("home_forecast_live_diagnostics_active_source_unchanged", True),
        "shadow_only": True,
        "plan72_source": False,
    }
...
def install_live_diagnostic_sensor_contract() -> None:
    """Install the approved sensor descriptions before platform forwarding."""
...
class AnkerEmsHomeForecastLiveRuntime:
    ...
    def __init__(self, coordinator: Any) -> None:
        ...
        self.evaluation = AnkerEmsHomeForecastEvaluation(self.hass, self.entry.entry_id)
    ...
    @staticmethod
    def _internal_snapshot(data: dict[str, Any]) -> dict[str, Any]:
        return {
            key: deepcopy(value)
